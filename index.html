				...
				<div class="card-body login-card-body">
					...
					<form action="/login_action.php" method="POST">
						<div class="input-group mb-3">
							<input type="email" class="form-control" placeholder="Email (Type: fulan@mail.com)" name="email" />
							<div class="input-group-text">
								<span class="fas fa-envelope"></span>
							</div>
						</div>
						<div class="input-group mb-3">
							<input type="password" class="form-control" placeholder="Password (Type: 123)" name="password" />
							<div class="input-group-text">
